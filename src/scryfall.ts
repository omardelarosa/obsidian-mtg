...
export function promiseWrappedGetRequest<T>(options: RequestOptions): Promise<T> {
...
export function promiseWrappedPostRequest<T>(options: RequestOptions, postData: string): Promise<T> {
    return new Promise((resolve, reject) => {
        const req = httpsRequest(options, (response: any) => {
            response.setEncoding('utf8');
            let chunks: string = "";
...
export const getCardData = async (cardName: string, request = promiseWrappedGetRequest): Promise<ScryfallResponse> => {
...
export const getMultipleCardData = async (cardNames: string[], request = promiseWrappedPostRequest): Promise<ScryfallResponse> => {
