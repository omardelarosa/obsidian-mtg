export function createSpan(root: Element, params?: { cls?: string | string[], text?: string }): HTMLSpanElement {
...
export function createDiv (root: Element, params?: { cls?: string | string[], text?: string }): HTMLDivElement {
    if (root.createDiv) {
